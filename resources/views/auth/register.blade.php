    ...
    <div class="container">
        <form action="/auth/register" method="post">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-6"> <input class="form-control" name="birth" placeholder="Birth" type="text">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-6 col-md-6"> <input class="form-control" name="email" placeholder="Email" type="text">
                </div>
                <div class="col-xs-6 col-md-6"> <input class="form-control" name="phone" placeholder="Phone" type="text">
                </div>
            </div>
            <div class="row">
